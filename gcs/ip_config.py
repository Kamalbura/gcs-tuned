...
#   This copy lives under gcs/ so you can deploy the GCS folder standalone.
#   Edit ONLY this file on the GCS machine to change addresses/ports.
#   All GCS scripts import from here for consistency.
#
# INITIAL SETUP:
